"""
agents/supervisor.py — Superviseur du workflow agentic.
Analyse la question et retourne 'quran' ou 'hadith'.
"""
...
Réponds UNIQUEMENT par l'un de ces deux tokens, sans aucun autre texte :
  [quran]  → si la question porte sur le Coran (versets, sourates, tafsir, récitation)
  [hadith] → si la question porte sur les hadiths (paroles du Prophète ﷺ, Sunna, chaînes de transmission)
...
def route_question(question: str) -> str:
    ...
    # Supprime les balises <think>...</think> que Qwen3 peut générer
